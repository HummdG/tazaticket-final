class ConversationFlowSM:
    def __init__(self):
        """
        This is a state machine that will determine the conversation flow for the user.
        ...
        self.mode_of_conversation = None
        self.origin = None
    ...
    def get_missing_variables(self):
        ...
        for var_name, value in var_mapping.items():
            if value is None:
    ...
    def status(self):
        ...
        print(f"mode_of_conversation: {self.mode_of_conversation}")
